...
import { ConversationPageState } from "packages/products/src/socratic-draft/client/app/components/conversations/ConversationPageState";
...
describe("Socratic Draft conversation list states", () => {
  ...
  it("renders saved conversations as navigable list items", () => {
    ...
    expect(markup).toContain(
      'href="/products/socratic-draft/conversations/conversation-1/editor"',
    );
