---
title: How treating my job search like a product problem helped me see what’s really making software engineering recruitment hard in 2026
shortTitle: Product engineering is reshaping software hiring
description: How the shift toward product engineering is creating new challenges around impact articulation, product culture ambiguity and what companies really mean when they say they move fast.
createdAt: 2026-08-24
slug: product-engineering-software-hiring-2026
legacySlugs: []
coverImage: /images/writing/product-engineering-software-hiring-2026/cover-2000x840.jpg
coverImageAlt: A software engineer studies a complex product and recruitment process mapped across a large whiteboard.
coverImageSmall: /images/writing/product-engineering-software-hiring-2026/cover-1000x420.jpg
internalTags: []
externalTags:
  - productengineering
  - career
...
_"comfortable operating in ambiguity"_

_"aren't just ticket-takers"_
...
1. We "move fast" and break things.

2. We cut corners.

3. We optimise for volume.

4. We foster a high-pressure environment.

5. We don't care about work-life balance.


To be clear, I don't think this is what most companies mean when they talk about speed. But there are very different _reasonable_ ways to interpret speed:

1. We ship small. We scope requirements aggressively to deliver frequent incremental value that can be validated quickly.

2. We experiment often and learn fast. We optimise for knowledge and discovery to keep us moving forward.

3. Our codebase is optimised for well-defined boundaries and low cognitive load, reducing regression risk and allowing for safer agentic delegation.


I think the biggest issue is the inherent tension between ambiguous speed and product engineering itself. Product engineering requires _more_ from engineers. Deeper domain understanding, more involvement in product discovery, more critical thinking, more observation and iteration. "We move fast" is meaningless without being clear about how.
...
_"In the face of these challenges, how can I exercise my agency? What can I understand better, communicate better, select more carefully, or change about my own approach?"_
...
_"What evidence is there that engineers are expected to own or meaningfully participate in product discovery? What exactly do engineers own or influence?"_

_"How do engineers understand the domain? Is there evidence of deep domain learning, domain modelling, or working closely with users AND domain experts?"_

_"What is the team's definition of ready? Are engineers expected to define the problem, the outcome and what success looks like? Are outcomes measured quantitatively?"_

_"Does the role description consistently qualify its engineering expectations with evidence about how it supports engineers to achieve them?"_

_"If the team says they move fast, do they explain what fast means, what trade-offs they're making to achieve it, and how they mitigate any risks that the speed introduces?"_
