...
is not part of the current Socratic Draft product direction. This document
...
boundary. Socratic Draft's purpose is to help a person discover, test, organise,
...
Socratic Draft adds another editing system and a conversion boundary without
...
Socratic Draft may help organise thinking and arguments through its own product
