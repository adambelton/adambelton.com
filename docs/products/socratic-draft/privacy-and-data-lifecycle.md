...
Review this note before public launch and whenever The Socratic Draft changes its
AI provider, prompts and submitted data, persistence, retention, restoration,
clearing, drafts, publishing, usage tracking, or categories of requested writing.
