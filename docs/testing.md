...
`packages/products/src/thoughtform/testing/browser`. Those hosts provide a
...
product package. ThoughtForm client tests live beside its pages and
...
their concrete product adapters, such as the ThoughtForm Prisma store. A
