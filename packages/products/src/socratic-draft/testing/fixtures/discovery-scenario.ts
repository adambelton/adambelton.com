import type { ConversationModelRequest } from "packages/products/src/socratic-draft/server/capabilities/conversation";
import type { ProposedIdea } from "packages/products/src/socratic-draft/server/capabilities/idea-map";
import type { ConversationModel } from "packages/products/src/socratic-draft/server/capabilities/conversation";
import {
  ASSISTANT_MOVES,
  IDEA_DISPOSITIONS,
  READINESS_ACTIONS,
