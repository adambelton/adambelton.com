...
export async function sendTemporaryIdeaAction(
  ...
  return sendIdeaAction(
    `/api/products/socratic-draft/conversation/${encodeURIComponent(conversationId)}/ideas/${encodeURIComponent(ideaId)}`,
    request,
    fetcher,
  );
}
...
export async function sendPersistentIdeaAction(
  ...
  return sendIdeaAction(
    `/api/products/socratic-draft/conversations/${encodeURIComponent(conversationId)}/ideas/${encodeURIComponent(ideaId)}`,
    request,
    fetcher,
  );
}
