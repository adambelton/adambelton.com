...
import {
  loadConversation,
  loadConversations,
} from "packages/products/src/socratic-draft/client/app/modules/conversations/load-conversations";

describe("Socratic Draft conversation requests", () => {
  ...
  it("loads an encoded conversation detail URL", async () => {
    ...
    expect(fetcher).toHaveBeenCalledWith(
      "/api/products/socratic-draft/conversations/conversation%2Fone",
    );
  });
