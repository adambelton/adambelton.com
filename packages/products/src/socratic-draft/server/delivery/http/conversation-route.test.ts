...
import { createConversationRoute } from "packages/products/src/socratic-draft/server/delivery/http";
import type {
  AppendConversationTurnInput,
  TemporaryConversationStore,
} from "packages/products/src/socratic-draft/server/capabilities/conversation";
import type { ConversationResponder } from "packages/products/src/socratic-draft/server/application/workspace";
import type {
  ConversationMessage,
