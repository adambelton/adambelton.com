...
} from "packages/products/src/socratic-draft/server/application/workspace";
import { parseConversationRequest } from "packages/products/src/socratic-draft/server/delivery/http/conversation-request";
import { handleIdeaActionRequest } from "packages/products/src/socratic-draft/server/delivery/http/idea-action-handler";
...
import { validateDraftSelection } from "packages/products/src/socratic-draft/server/delivery/http/draft-selection-context";
