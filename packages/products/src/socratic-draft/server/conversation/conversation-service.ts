...
const SOCRATIC_DRAFT_SYSTEM_PROMPT = [
  ...
  "Return at most three unresolved questions. Each must arise directly from a tension or uncertainty already expressed by the user and remain appropriate to discovery; do not introduce articulation questions about audience, tone, form, evidence, or structure unless the user has begun that work.",
