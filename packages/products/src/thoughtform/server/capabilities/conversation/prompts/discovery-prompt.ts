...
export const THOUGHTFORM_SYSTEM_PROMPT_FALLBACK = `
<role>
...
export const THOUGHTFORM_SYSTEM_PROMPT_DEFINITION = {
  name: "thoughtform/discovery",
  fallback: THOUGHTFORM_SYSTEM_PROMPT_FALLBACK,
