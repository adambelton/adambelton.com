...
import { createDraftStore } from "packages/products/src/thoughtform/server/capabilities/drafting/draft-store";
import { TestDraftPersistence } from "packages/products/src/thoughtform/testing/fakes/test-draft-persistence";
import { DraftService } from "packages/products/src/thoughtform/server/capabilities/drafting/draft-service";
import type { DraftCompositionModelInput } from "packages/products/src/thoughtform/server/capabilities/drafting/ports/draft-model";
import {
