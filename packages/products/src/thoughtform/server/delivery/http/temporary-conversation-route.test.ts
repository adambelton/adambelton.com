...
import type { TemporaryConversationStore } from "packages/products/src/thoughtform/server/capabilities/conversation";
...
describe("temporary ThoughtForm conversation route", () => {
