...
import type { ProposedIdea } from "packages/products/src/thoughtform/server/capabilities/idea-map";
import type { ConversationModel } from "packages/products/src/thoughtform/server/capabilities/conversation";
import {
  ASSISTANT_MOVES,
  IDEA_DISPOSITIONS,
  READINESS_ACTIONS,
