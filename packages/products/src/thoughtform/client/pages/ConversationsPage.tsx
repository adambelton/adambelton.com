...
import { loadConversations } from "packages/products/src/thoughtform/client/conversations/actions/load-conversations";
      ...
      <button
        ...
        onClick={async () => {
          ...
          try {
            ...
            components.navigate(
              `/products/thoughtform/conversations/${conversation.id}/editor`,
            );
          } catch (createError) {
            setError(
